...
export function Hero() {
  return (
    ...
    >
      ...
      <Reveal className="pointer-events-none relative z-20 w-full text-center">
        ...
        <h1 className="pointer-events-none select-none break-words font-display text-[clamp(4rem,11vw,10rem)] font-extrabold uppercase leading-[0.88] gradient-text-hero">
          SAP Commerce
        </h1>
      </Reveal>
      <div className="pointer-events-auto absolute inset-0 z-10 flex items-center justify-center px-[clamp(1.5rem,5vw,5rem)] pt-10">
        <HeroPortraitReveal />
      </div>
